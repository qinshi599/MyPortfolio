...
const Contact = () => {
  ...
  return (
    ...
    id="contact" className='w-full px-[12%] py-10 scroll-mt-20 bg-[url("/footer_bg_color.png")] bg-no-repeat bg-center
    bg-[length:90%_auto] dark:bg-none'>
        ...
        onSubmit={onSubmit} className="max-w-2xl mx-auto">
            ...
            type="summit" className="py-3 px-8 w-max flex items-center justify-between gap-2 bg-black/80
            text-white rounded-full mx-auto hover:bg-black duration-500 dark:bg-transparent dark:border-[0.5px] dark:hover:bg-darkHover">Summit Now <Image src={assets.right_arrow_white} alt="arrow white" 
